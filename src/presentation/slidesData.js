// ── slidesData.js ─────────────────────────────────────────────────────────────
// All slide content for WaterResourcesPresentation.
// Import with: import { SLIDES, SECTION_COLORS, SECTIONS } from "./slidesData.js"
// ─────────────────────────────────────────────────────────────────────────────
...
export const SLIDES = [
  ...
  { id: 140, section: "Trivia",
    title: "Water Facts That Matter",
    subtitle: "Key facts about H₂O — distribution, biology, and everyday use.",
    bullets: [
      "Only 0.01% of Earth's water is in lakes & streams — accessible to life.",
      "Water makes up 83% of blood, 75% of brain & muscles, 22% of bones.",
      "Humans survive ~21 days without food but only ~3 days without water.",
      "A dripping faucet (1 drop/sec) wastes 3,000 gallons per year.",
      "One gallon of milk requires 1,000 gallons of water to produce.",
      "Generating daily home electricity consumes ~250 gallons of water.",
      "A 5-minute shower uses 10–25 gal vs. up to 70 gal for a bath.",
      "Tap water costs 1/1,740th the price of an equivalent bottled water refill.",
    ],
    type: "bullets",
  },
  { id: 141, section: "Trivia",
    title: "Water World — Global Crisis & Consumption",
    subtitle: "Staggering facts about access, industry, and conservation.",
    bullets: [
      "4 in 10 people worldwide lack access to clean water or must walk to get it.",
      "5,000 children die every day from waterborne diseases.",
      "Poor water quality costs India's economy $20 billion per year.",
      "It takes 300 tons of water to manufacture just 1 ton of steel.",
      "The U.S. uses more water in one day than it uses oil in an entire year.",
      "Producing 2L of Coca-Cola requires 5L of water; Coke uses 227M gallons daily.",
      "In the U.S., 1 in 6 gallons of treated water is lost to leaks.",
      "U.S. home toilets flush 5.7 billion gallons daily.",
      "U.S. per capita water use peaked at 1,920 gal/day (1980); fell to 1,360 by 2005.",
    ],
    type: "bullets",
  },
  ...
  { id: 155, section: "Tipid Tubig", title: "Tip 5", content: "As much as possible, always run the washing machine at full load. Savings: 5-10 Liters every load. Use the proper amount of detergent when washing clothes. Less water for rinsing will be used.", type: "trivia-intro" },
